...
|---|---|---|---|
| `S0_INTAKE` | Bound project and authority | `G0` | Mode, profile, objective, scope, interface and visualization scopes, authority, budgets, stops |
...
| `S3_SOLUTION_DESIGN` | Design usable and operable behavior | `G3` | UX, alternatives, architecture, contracts, risks, test strategy; complete UI and data-visualization contracts when applicable |
...
| `S6_INDEPENDENT_VERIFICATION` | Judge against original objective | `G6` | Product, UX, engineering, data, security, failure evidence; complete UI and data-visualization verification when applicable |
